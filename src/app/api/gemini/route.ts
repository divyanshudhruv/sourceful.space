...
- If it is NOT a good startup idea or not open-source related, reply with only this: "Not a good startup idea or not open-source related.\nWhy?: <reason>"
- If it IS a good open-source startup idea, write a short description (about 50 words) summarizing the idea, its usefulness, and potential.
